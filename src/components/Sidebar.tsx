...
const Sidebar: React.FC = () => {
    ...
    return (
        <div className="fixed z-50 flex flex-col justify-between gap-6 md:visible invisible top-4 left-4 h-[94%] w-fit bg-gray-700 shadow-lg shadow-gray-900/50 p-2 rounded-xl">
