    ...
    return (
        <Carousel {...carouselProps}>
            <div className='w-full h-full flex justify-center items-center'>
                <Image src="/png/carousel/2.png" alt='' width={600} height={284}></Image>
            </div>
            <div className='w-full h-full flex justify-center items-center'>
                <Image src="/png/carousel/3.png" alt='' width={600} height={284}></Image>
            </div>
            <div className='w-full h-full flex justify-center items-center'>
                <Image src="/png/carousel/6.png" alt='' width={600} height={284}></Image>
            </div>
            <div className='w-full h-full flex justify-center items-center'>
                <Image src="/png/carousel/5.png" alt='' width={600} height={284}></Image>
            </div>
            <div className='w-full h-full flex justify-center items-center'>
                <Image src="/png/carousel/4.png" alt='' width={600} height={284}></Image>
            </div>
